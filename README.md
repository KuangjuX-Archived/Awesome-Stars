...
- [StudyNotes](https://github.com/krislinzhao/StudyNotes) - 📚JAVA、Spring、SpringMVC、SpringBoot、Mybatis、Vue、MySQL、MongoDB、Radis、Docker、Nginx、......笔记
- [pumpkin-book](https://github.com/datawhalechina/pumpkin-book)
- [technical_books](https://github.com/TIM168/technical_books) - 📚🔥收集全网最热门的技术书籍 (GO、黑客、Android、计算机原理、人工智能、大数据、机器学习、数据库、PHP、java、架构、消息队列、算法、python、爬虫、操作系统、linux、C语言)，不间断更新中♨️
...
- [the-way-to-go](https://github.com/unknwon/the-way-to-go_ZH_CN) - 《The Way to Go》中文译本，中文正式名《Go 入门指南》
...
- [Python3-Spider](https://github.com/wkunzhi/Python3-Spider) - Python爬虫实战 - 模拟登陆各大网站 包含但不限于：滑块验证、拼多多、美团、百度、bilibili、大众点评、淘宝，如果喜欢请start ❤️
- [injetlee/Python](https://github.com/injetlee/Python) - Python脚本。模拟登录知乎， 爬虫，操作excel，微信公众号，远程开机
- [geekcomputers/Python](https://github.com/geekcomputers/Python) - My Python Examples

### PHP

- [create-your-own-php-framework](https://github.com/CraryPrimitiveMan/create-your-own-php-framework) - 构建自己的PHP框架
...
- [qq281113270/vue](https://github.com/qq281113270/vue)
- [ustbhuangyi/vue-analysis](https://github.com/ustbhuangyi/vue-analysis)
- [yisainan/vue](https://github.com/yisainan/vue) - 💯 比较好的vue项目,值得借鉴与学习
...
- [https://github.com/996icu/996.ICU](https://github.com/996icu/996.ICU) - Repo for counting stars and contributing. Press F to pay respect to glorious developers.
...
- [javaSwing/NeteaseCloudWebApp](hub.com/javaSwing/NeteaseCloudWebApp) - This is a vue for NeteaseCloud projects!
...
- [WePeiyang-RN](https://github.com/Cyphexl/WePeiyang-RN) - The App for Tianjin University. Now in React-Native.
